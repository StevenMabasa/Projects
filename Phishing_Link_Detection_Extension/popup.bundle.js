...
// Bundled dependencies would go here
// For now, let's create a simpler version that works without bundling
  ...
  try {
    ...
    if (dashboardBtn) {
      dashboardBtn.addEventListener("click", () => {
        try {
          ...
          console.log("React Dashboard opened successfully");
        } catch (error) {
          console.error("Error opening React dashboard:", error);
          output.textContent = "Error opening dashboard. Please try again.";
    ...
    if (testBtn) {
      testBtn.addEventListener("click", () => {
        try {
          // Open React dashboard in new tab for testing
          chrome.tabs.create({ url: chrome.runtime.getURL("react-dashboard.html") });
          console.log("React Dashboard (test) opened successfully");
        } catch (error) {
          console.error("Error opening React dashboard:", error);
          output.textContent = "Error opening dashboard. Please try again.";
          output.className = "error";
